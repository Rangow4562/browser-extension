...
const manifest = withSidePanel({
  ...
  host_permissions: ['https://www.dynatrace.com/*', 'https://wkf10640.apps.dynatrace.com/*'],
  permissions: ['storage', 'scripting', 'tabs', 'debugger'],
  ...
  content_scripts: [
    {
      matches: ['https://www.dynatrace.com/*', 'https://wkf10640.apps.dynatrace.com/*'],
